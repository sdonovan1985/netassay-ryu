...
class Mapper:
  ...
  def loadTypeFiles(self):
    ...
    self.loadFile('pyretic/modules/netassay/me/dns/dnsclassifier/servicedef/background.ini', 'BACKGROUND')
    self.loadFile('pyretic/modules/netassay/me/dns/dnsclassifier/servicedef/video.ini', 'VIDEO')
    self.loadFile('pyretic/modules/netassay/me/dns/dnsclassifier/servicedef/web.ini', 'WEB')
